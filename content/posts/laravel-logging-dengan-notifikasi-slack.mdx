...
1. Buatlah channel pada akun Slack Anda. Sebagai contoh, nama channelnya adalah laravel-log-notification ![](/images/posts/laravel-logging-dengan-notifikasi-slack/Cuplikan_layar_2024-01-29_184104.png)
2. Kemudian buku website [Slack API](https://api.slack.com/apps) lalu klik tombol Create New App dan pilih From Scratch ![](/images/posts/laravel-logging-dengan-notifikasi-slack/Cuplikan_layar_2024-01-29_184508.png)![](/images/posts/laravel-logging-dengan-notifikasi-slack/Cuplikan_layar_2024-01-29_184449.png)
3. Selanjutnya isikan App Name lalu pilih workspace Slack Anda dan klik Create App![](/images/posts/laravel-logging-dengan-notifikasi-slack/Cuplikan_layar_2024-01-29_184535.png)
4. Kemudian pada sidebar Slack API pilih Incoming Webhooks dan aktifkan![](/images/posts/laravel-logging-dengan-notifikasi-slack/Cuplikan_layar_2024-01-29_184932.png)
5. Setelah diaktifkan, klik Add New Webhook to Workspace dan pilih channel yang sudah dibuat sebelumnya![](/images/posts/laravel-logging-dengan-notifikasi-slack/Cuplikan_layar_2024-01-29_184955.png)![](/images/posts/laravel-logging-dengan-notifikasi-slack/Cuplikan_layar_2024-01-29_185021.png)![](/images/posts/laravel-logging-dengan-notifikasi-slack/Cuplikan_layar_2024-01-29_185047.png)
